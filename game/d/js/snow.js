...
window.onload = function ()
{
	if(window.image_box)
	{
		...
		start_x = image_box.offsetLeft;
		start_y = image_box.offsetTop;
	}
	else if (ns6up)
	{
...
function snowIE_NS6()
{
	...
	{
		yp[i] += sty[i];
		if (yp[i] > start_y + doc_height + 20)
		{
			xp[i] = Math.random()*(start_x + doc_width - am[i] - 30);
			yp[i] = start_y - 20;
