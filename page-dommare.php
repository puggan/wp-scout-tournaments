...
// 		echo "<th>Klass</th>";
                                        ...
                                        foreach ($matcher as $match) {
                                            while ($next_break and $next_break->break_from < $match->match_time) {
                                                ...
                                                echo '<tr><td></td><td>' . $short_time . '</td><td colspan="3" style="text-align: center;">' . htmlentities(
                                                        $next_break->break_name,
                                    ...
                                    <div class="entry-content">
                                        <?php the_content(); ?>
                                        <?php wp_link_pages(['before' => '<div class="page-link"><span>' . __('Pages:', 'twentyeleven') . '</span>', 'after' => '</div>']); ?>
                                    </div><!-- .entry-content -->
